...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, num_agents):
        ...
        #self.hard_copy(self.actor_target, self.actor_local) # Referencia slack
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, random_seed).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed).to(device)
        #self.hard_copy(self.critic_target, self.critic_local) ## Referencia slack
   ...
   #Modification for n agents
    def act(self, agents_states, add_noise=True):
        ...
        agents_states = torch.from_numpy(agents_states).float().to(device)
